...
후공이 방어를 선택하면, 같은 라운드에서는 이미 선공이 행동한 뒤이므로 방어 효과가 적용될 기회가 없습니다. 이를 보상하기 위해 **후공의 방어는 다음 라운드 선공의 공격까지 유효**합니다. 선공의 방어는 같은 라운드 후공 공격에 즉시 적용되므로 carry하지 않습니다.

> 대안: 후공 방어를 즉시 소멸시키면 구현이 단순해지지만, 후공에게 방어 스킬이 사실상 무의미해져 밸런스가 깨집니다. 1라운드 carry는 최소한의 변경으로 양쪽 모두에게 방어의 가치를 보장합니다.
